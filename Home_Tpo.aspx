<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Home_Tpo.aspx.cs" Inherits="Home" %>
...
<body>
                        ...
                        <div class="collapse navbar-collapse main-menu-item" id="navbarSupportedContent">
                            <ul class="navbar-nav">
                                <li class="nav-item">
                                 ...
                                 <li class="nav-item">
                                    <a class="nav-link" href="manage_student.aspx">Students</a>
                                </li>
                                
                                 <li class="nav-item">
                                    <a class="nav-link" href="manage_files.aspx">View Files</a>
                                </li>
                                 <li class="nav-item">
    ...
    <!-- Header part end-->
        ...
        <div class="container">
             ...
             <asp:Image ID="Image1" runat="server" Height="530px" ImageUrl="~/Admin/img/1.jpg" Width="1000px" />
